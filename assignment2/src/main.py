from load_files import load_all_pang_docs, load_all_docs
from doc2vec import Doc2VecSVM
from cross_validate import cross_validate, validation_set, permutation_test
from svm import SVM
...
p, cs = cross_validate(doc2vecsvm, the_rest)
...
pv_svmp = permutation_test(cs, svm_p)  # 0.001 !!
